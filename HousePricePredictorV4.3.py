...
def ReadInTrainingData():
    ...
    try:
        ...
        print("Couldn't find file \"InputTrainingData.csv\"")
        sys.exit()
    except:
        print("Something went wrong trying to open file \"InputTrainingData.csv\"")
        sys.exit()
...
def ReadInTestData():
    ...
    try:
        ...
        print("Couldn't find file \"InputTestData.csv\"")
        sys.exit()
    except:
        print("Something went wrong trying to open file \"InputTestData.csv\"")
        sys.exit()
